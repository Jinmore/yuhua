   ...
   <div class="inner clear">
        ...
        <div class="right fr">
            <div class="ban1 clear">
              <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"get\" data=\"op=get&tag_md5=3594c85b9469291a2b74e1797d84ccbc&sql=select+%2A+from+%60ld_news%60++where+catid%3D%24catid+and+title+like+%27%25%24catname%25%27+&num=1\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}pc_base::load_sys_class("get_model", "model", 0);$get_db = new get_model();$r = $get_db->sql_query("select * from `ld_news`  where catid=$catid and title like '%$catname%'  LIMIT 1");while(($s = $get_db->fetch_next()) != false) {$a[] = $s;}$data = $a;unset($a);?>
              <?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
              <a href="<?php echo $r['url'];?>" class="ban1-l fl"><img src="<?php echo $r['thumb'];?>" class="transition"></a>
              <div class="ban1-r fr">
