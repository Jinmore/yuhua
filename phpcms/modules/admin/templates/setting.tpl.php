...
<table width="100%"  class="table_form">
  ...
  <tr>
	...
	<tr>
    <th width="120">咨询电话</th>
    <td class="y-bg"><input type="text" class="input-text" name="setconfig[contact_tel]" id="contact_tel" size="50" value="<?php echo CONTACT_TEL?>" /></td>
  </tr>
	<tr>
    <th width="120">咨询手机</th>
    <td class="y-bg"><input type="text" class="input-text" name="setconfig[contact_phone]" id="contact_phone" size="50" value="<?php echo CONTACT_PHONE?>" /></td>
  </tr>
	<tr>
    <th width="120">备案号</th>
