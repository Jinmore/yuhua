...
<textarea name="info[description]" cols="40" rows="8" id="content"><?php echo $description;?></textarea>
<?php echo form::editor('content','basic','','','',1,1)?></td>
      </tr>
			<tr>
		        <th>栏目描述：</th>
		        <td><script type="text/javascript" src="/statics/js/ckeditor/ckeditor.js"></script>
		<textarea name="info[description_er]" cols="50" rows="8" id="content"><?php echo $description_er;?></textarea>
		<?php echo form::editor('content','basic','','','',1,1)?></td>
